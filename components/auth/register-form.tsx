...
export function RegisterForm() {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <Input
              ...
              disabled={loading}
              minLength={6}
              className="bg-gray-900/50 border-gray-800 text-white placeholder:text-gray-500 focus:border-gray-700 focus:ring-gray-700 h-12 rounded-lg pr-10"
            />
            <button
              type="button"
      ...
      {/* Separator - Commented out for v1.0 (no OAuth) */}
      {/* <div className="relative">
      ...
      {/* Social Login Buttons - Commented out for v1.0 (no OAuth) */}
